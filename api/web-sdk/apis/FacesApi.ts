...
import {
    type FacePreviewIn,
    FacePreviewInFromJSON,
    FacePreviewInToJSON,
} from '../models/FacePreviewIn';
import {
    type FaceUpdate,
    FaceUpdateFromJSON,
    FaceUpdateToJSON,
...
export class FacesApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for previewFace without sending the request
     */
    async previewFaceRequestOpts(requestParameters: PreviewFaceRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['faceId'] == null) {
            throw new runtime.RequiredError(
                'faceId',
                'Required parameter "faceId" was null or undefined when calling previewFace().'
            );
        }

        if (requestParameters['facePreviewIn'] == null) {
            throw new runtime.RequiredError(
                'facePreviewIn',
                'Required parameter "facePreviewIn" was null or undefined when calling previewFace().'
            );
        }
        ...
        return {
            ...
            headers: headerParameters,
            query: queryParameters,
            body: FacePreviewInToJSON(requestParameters['facePreviewIn']),
        };
    }

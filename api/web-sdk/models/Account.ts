...
/**
 * A wallet's smart account on chain: the address that owns objects and signs
 * actions, and the key that controls it.
 * 
 * @export
 * @interface Account
 */
export interface Account {
    /**
     * The address that owns objects and takes actions. This is the account's
     * identity everywhere on the network.
     * 
     */
    address: string;
    /**
     * Always `SMART_WALLET`. Every account here is a smart account, which is what
     * lets a passkey, a crypto wallet or Dual itself stand behind the same
     * address.
     * 
     */
    type: AccountTypeEnum;
    /**
     * What is allowed to act for this account — its passkey, its crypto wallet, or a key Dual holds on its behalf.
     */
    controller: AccountController;
    /**
     * How the account's address was worked out. The address exists and can
     * receive objects before anything is deployed on chain for it.
     * 
     */

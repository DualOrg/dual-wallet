...
/**
 * How the caller proved they were allowed to run this action.
 * 
 * @export
...
export interface ActionAccess {
    /**
     * Access rule that authorized the action.
     */
    type: ActionAccessTypeEnum;
    /**
     * Addresses accepted by a `whitelist` access rule.
     */
    whitelist?: Array<string>;
    /**
     * Token identifiers and minimum balances required by a `token` access rule.
     */
    token?: { [key: string]: number; };
    /**
     * Object used to satisfy token-based or object-bound access, when applicable.
     */
    objectId?: string;
    /**
     * Root used to verify a compact allowlist, when the rule uses one.
     */
    merkleRoot?: string;
    /**
     * Proof that the caller is included in the rule's allowlist.
     */

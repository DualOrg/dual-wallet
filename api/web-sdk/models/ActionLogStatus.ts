...
/**
 * How far an action has got towards being permanent.
 * 
 * | Value | Meaning |
 * | --- | --- |
 * | `pending` | Done and recorded, waiting to be settled on chain |
 * | `completed` | Settled — the batch carrying it is anchored |
 * | `failed` | Settling could not be completed |
 * 
 * @export
 */

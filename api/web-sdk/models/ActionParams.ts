...
/**
 * The details the action was run with.
 * 
 * @export
...
export interface ActionParams {
    /**
     * Object acted on, for actions that target one object.
     */
    id?: string;
    /**
     * Template used by actions such as `mint` and `redeem`.
     */
    templateId?: string;
    /**
     * Number of objects requested by a `mint` action.
     */
    num?: number;
    /**
     * Recipient address used by `mint` or `transfer`.
     */
    to?: string;
    /**
     * Permit secret presented with the action, when a permit was used. The
     * recorded action nonce has already advanced, so this value cannot
     * authorize another action.
     * 
     */
    permitSecret?: string;
    /**
     * Fingerprint of action data that was signed separately from this record.
     */
    dataHash?: string;
}

...
/**
 * The permission an action was run under, when it was not the owner acting.
 * 
 * @export
...
export interface ActionPermit {
    /**
     * The fingerprint of the secret that was presented.
     * 
     */
    commitment: string;
    /**
     * Which action the permission allowed.
     * 
     */
    actionType: string;
    /**
     * The object's action number the permission was tied to.
     * 
     */
    nonce: number;
    /**
     * The address the permission was restricted to, if it was.
     * 
     */
    recipient?: string;
    /**
     * When the permission stopped working.
     * 
     */
    deadline?: number;
}

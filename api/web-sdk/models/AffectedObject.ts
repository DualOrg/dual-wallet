...
/**
 * An object an action touched, with its fingerprints before and after — enough
 * to verify the change against what was written on chain.
 * 
 * @export
...
export interface AffectedObject {
    ...
    /**
     * Its fingerprint after.
     * 
     */
    nextStateHash: string;
    /**
     * Its history fingerprint before.
     * 
     */
    prevIntegrityHash: string;
    /**
     * Its history fingerprint after.
     * 
     */
    integrityHash: string;
    /**
     * The entry in the object's history that records this.
     * 
     */
    stateChangeId: string;
    /**
     * Whether the action created, updated, or deleted the object.
     */
    changeType: string;
}

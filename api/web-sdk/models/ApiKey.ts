...
/**
 * An API key's metadata. The secret is never included; it is returned once, by
 * `POST /api-keys`.
 * 
 * @export
 * @interface ApiKey
...
export interface ApiKey {
    ...
    id: string;
    /**
     * Your label for this key.
     */
    name: string;
    /**
     * When the key stops working. There is no renewal: rotate by creating a new
     * key and deleting this one.
     * 
     */
    expiresAt: Date;
    /**
    ...
    whenModified: Date;
    /**
     * When the key last authenticated a request. Updated on a best-effort basis
     * and can lag real use by about a minute.
     * 
     */
    lastUsedAt?: Date;
}

...
export interface ApiKeyCreate {
    /**
     * Your label for this key. Shown when listing keys.
     */
    name: string;
    /**
     * How long the key stays valid, in hours. At most 8760 (one year),
     * which is also the default when omitted.
     * 
     */
    ttlHours?: number;
    /**
     * What the key may do. At least one entry, and never more than the
     * creating wallet's own permissions.
     * 
     */

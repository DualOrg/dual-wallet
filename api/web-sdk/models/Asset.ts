...
/**
 * A file — a picture, a document, a piece of media. Upload one with
 * `POST /assets` and refer to it here.
 * 
 * @export
 * @interface Asset
 */
export interface Asset {
    ...
    name?: string;
    /**
     * Where it sits with its storage provider.
     */
    key?: string;
    /**
     * What kind of file it is, for example `image/png`.
     */
    type?: string;
    /**
     * Where to load it from. A private file needs a download link from
     * `GET /assets/{assetId}/download` instead.
     * 
     */
    url: string;
    /**
    ...
    hash?: string;
    /**
     * Whether anyone with the address can open it.
     */
    isPublic?: boolean;
    /**

...
/**
 * A URL that reads an asset's bytes.
 * @export
 * @interface AssetURL
 */
export interface AssetURL {
    /**
     * Fetch this to get the file. A Google Cloud Storage URL is signed and
     * expires 15 minutes after it was issued; an IPFS gateway URL does not
     * expire.
     * 
     */
    url: string;

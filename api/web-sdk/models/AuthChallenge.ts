...
/**
 * A one-off string to sign, which proves the signer holds the key right now.
 * 
 * @export
...
export interface AuthChallenge {
    ...
    id?: string;
    /**
     * The value to sign with a crypto wallet's `personal_sign` method. Passkey
     * flows obtain their challenge from the corresponding passkey options
     * endpoint instead.
     * 
     */
    challenge: string;
    /**
     * When it stops being accepted, 60 seconds after it was issued. Fetch a
     * challenge immediately before you need it.
     * 
     */
    expiresAt: Date;
    /**

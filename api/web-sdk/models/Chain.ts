...
/**
 * Where an object stands on chain, once it has been mirrored there as a
 * collectible.
 * 
 * @export
 * @interface Chain
...
export interface Chain {
    /**
     * Whether the owner has claimed the object on chain. A claimed object cannot
     * be transferred here until it comes back.
     * 
     */

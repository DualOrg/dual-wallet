...
/**
 * A run of finalized batches compressed into one anchored commitment, so that a
 * long history can be verified without walking every batch in it.
 * 
 * @export
...
export interface Checkpoint {
    ...
    sequence: number;
    /**
     * Hash of the first batch covered.
     */
    startHash: string;
    /**
     * Sequence of the first batch covered.
     */
    startSequence: number;
    /**
     * Sequence of the last batch covered.
     */
    endSequence: number;
    /**
     * Hash of the last batch covered.
     */
    endHash: string;
    /**
     * Address that submitted the checkpoint commitment.
     */
    sender: string;
    /**
     * Layer 2 transaction that anchored the checkpoint, once submitted.
     */
    l2TxHash?: string;
    /**
     * Public IPFS location of the checkpoint data, once stored.
     */
    ipfsUrl?: string;
    /**
     * Current checkpoint pipeline stage.
     */
    status: CheckpointStatus;
    /**
     * Validity proof, once the proving stage has completed.
     */
    proof?: Proof;
    /**
     * Identifier assigned to this checkpoint's proof request.
     */
    proofId?: string;
    /**
     * Diagnostic message when checkpoint processing failed.
     */
    error?: string;
    /**
     * Batches covered by this checkpoint, in sequence order.
     */
    affectedBatches?: Array<AffectedBatch>;
    /**
     * When checkpoint processing reached a terminal state.
     */
    whenCompleted?: Date;
    /**
     * When the checkpoint last moved to another pipeline stage.
     */
    whenModified?: Date;
    /**
     * When checkpoint processing began.
     */
    whenCreated: Date;
}

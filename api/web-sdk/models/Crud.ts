...
/**
 * What may be done in one area. Each is granted separately, so read-only access
 * is simply `read` on its own.
 * 
 * @export
 * @interface Crud
 */
export interface Crud {
    /**
     * May look at things in this area.
     */
    read: boolean;
    /**
     * May make new ones.

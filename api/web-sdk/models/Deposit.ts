...
/**
 * An on-chain payment observed for an organization's balance.
 * 
 * @export
 * @interface Deposit
 */
export interface Deposit {
    /**
     * Stable identifier of this deposit event.
     */
    id: string;
    /**
     * The organization named by the deposit event.
     */
    orgId: string;
    /**
    ...
    /**
     * When the deposit was first observed.
     */
    whenCreated: Date;
    /**
     * When the deposit status last changed.
     */
    whenModified: Date;
}

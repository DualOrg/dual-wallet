...
/**
 * Where a deposit is in its crediting life cycle.
 * 
 * | Value | Meaning |
 * | --- | --- |
 * | `pending` | Observed on chain and queued for crediting |
 * | `completed` | Downstream credit acknowledgement received |
 * | `failed` | The deposited asset is not supported |
 * 
 * @export
 */

...
/**
 * Leave an object at a place for another user to find and pick up.
 * 
 * While it is dropped it has no owner, and anybody at that place can claim it
 * with a `pickup`.
 * 
 * @export
 * @interface Drop
...
export interface Drop {
    ...
    latitude: number;
    /**
     * Longitude of the place, in degrees.
     */
    longitude: number;
}

...
/**
 * A design that objects wear. One face can hold a different look for each
 * place an object appears.
 * 
 * @export
 * @interface Face
 */
export interface Face {
    ...
    id: string;
    /**
     * What you call this design. Unique within your organization.
     */
    name: string;
    /**
     * How inline designs are drawn. `go-template` fills in
     * `{{.placeholder}}` values from the object.
     * 
     */
    renderer?: FaceRendererEnum;
    /**
     * Extra values available to every design in this face.
     */
    rendererConfig?: { [key: string]: any; };
    /**
     * One design per place the object appears.
     */
    views?: Array<FaceView>;
    /**
     * An older way of pointing at a page of your own. Use a view's `url`.
     * @deprecated
     */
    url?: string;
    /**
     * An older way of writing a single design. Use a view's `content`.
     * 
     * @deprecated
     */
    content?: string;
    /**
     * An older form of `renderer_config`.
     * @deprecated
     */
    config?: { [key: string]: any; };
    /**
     * Files this design uses, such as logos and background images.
     */
    assets?: Array<Asset>;
    /**
     * When the face was created.
     */
    whenCreated: Date;
    /**
     * When the face was last changed.
     */
    whenModified: Date;
}

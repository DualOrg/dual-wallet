...
/**
 * Which object to draw, and which design to draw it with.
 * @export
 * @interface FacePreviewIn
 */
export interface FacePreviewIn {
    /**
     * The object to draw. It has to be one of your organization's.
     * 
     */
    objectId: string;
    /**
     * Which design to draw. Defaults to the object's own page.
     */

...
/**
 * The parts of a face to change. Send only what you want changed; sending
 * `views` replaces the whole set.
 * 
 * @export
...
export interface FaceUpdate {
    /**
     * What you call this design.
     */
    name?: string;
    /**
     * How inline designs are drawn.
     */
    ...
    /**
     * The complete set of designs. Include every variant you want to keep.
     * 
     */
    ...
    /**
     * Files this design uses.
     */
    assets?: Array<Asset>;
    /**
     * Updated automatically to the time of this face change.
     */
    whenModified?: Date;
}

...
/**
 * Changes to how many objects a template allows and when they may be created.
 * 
 * @export
...
export interface FactoryUpdate {
    /**
     * New lifetime supply limit. It cannot be lower than the number already
     * created. Negative values are treated as zero.
     * 
     */
    maxSupply?: number;
    /**
     * New time when object creation opens. An omitted, zero, or past value is
     * stored as the current time.
     * 
     */
    startTime?: Date;
    /**
     * New time when object creation closes.
     */
    endTime?: Date;
    /**
     * Stored for compatibility but not currently enforced during object
     * creation. Use action access rules to control who may mint.
     * 
     * @deprecated
     */

...
/**
 * What has been spent on fees. Every amount appears twice: in whole DUAL, and
 * in wei.
 * 
 * @export
 * @interface FeesOut
...
export interface FeesOut {
    /**
     * How many actions the sums cover.
     */
    count: number;
    /**
    ...
    interval?: Interval;
    /**
     * The same totals, split by whatever you grouped on. Comes back with
     * `include=breakdown`.
     * 
     */
    breakdown?: Array<FeesTimeData>;
    /**
     * The totals over time, one point per period. Comes back with
     * `include=series`.
     * 
     */

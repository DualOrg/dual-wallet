...
/**
 * Fees for one slice or one period.
 * @export
 * @interface FeesTimeData
 */
export interface FeesTimeData {
    /**
     * Which slice this is — an action name, or whatever you grouped on.
     */
    key: string;
    /**
    ...
    when: Date;
    /**
     * Spent altogether, in wei.
     */
    totalFeeWei: string;
    /**
     * Spent altogether, in DUAL.
     */
    totalFee: string;
    /**
     * The fixed part, in wei.
     */
    baseFeeWei: string;
    /**
     * The fixed part, in DUAL.
     */
    baseFee: string;
    /**
    ...
    /**
     * The same part, in DUAL.
     */
    dynamicFee: string;
    /**
     * How many actions it covers.
     */
    count: number;
}

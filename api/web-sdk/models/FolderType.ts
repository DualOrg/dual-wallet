...
/**
 * Which collection the file belongs to. Defaults to `assets`, and only `assets`
 * is returned by `GET /assets`.
 * 
 * | Value | Used for |
 * | --- | --- |
 * | `assets` | General files behind objects, templates and faces |
 * | `avatars` | Wallet and organization profile images |
 * | `support` | Attachments on support messages |
 * 
 * @export
 */

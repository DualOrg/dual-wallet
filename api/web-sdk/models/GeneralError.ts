...
export interface GeneralError {
    /**
     * A stable value your code can branch on. See **Errors** in the
     * introduction.
     * 
     */
    code: number;
    /**
     * What went wrong, in words. Written for a person reading a log; do not
     * match on it.
     * 
     */
    message: string;
    /**
     * Extra context, where there is any.
     */
    details?: object;
}

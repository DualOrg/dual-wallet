...
/**
 * One page of publicly visible objects and optional presentation data.
 * @export
 * @interface ListPublicSmartObjectsOut
 */
export interface ListPublicSmartObjectsOut {
    /**
     * The objects on this page, each with a way to show it when you asked for one.
     */
    items?: Array<PublicObjectView>;
    /**
     * The objects on this page, in the older form. Use `items` instead.
     * 
     * @deprecated
     */
    objects: Array<PublicSmartObject>;
    /**
     * An older way of describing how each object looks. Use
     * `include=display` and read `items[].display`.
     * 
     * @deprecated
     */
    faces?: Array<ObjectFaces>;
    /**
     * What can be done with each object, returned when you ask for
     * `actions=true`.
     * 
     */

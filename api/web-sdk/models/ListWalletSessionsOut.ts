...
import {
    WalletSessionFromJSON,
    WalletSessionFromJSONTyped,
    WalletSessionToJSON,
    WalletSessionToJSONTyped,
} from './WalletSession';

/**
 * Where this account is signed in.
 * @export
 * @interface ListWalletSessionsOut
 */
export interface ListWalletSessionsOut {
    /**
     * One entry per browser or device, newest first. At most ten.
     * 
     */
    sessions: Array<WalletSession>;
}

/**
 * Check if a given object implements the ListWalletSessionsOut interface.
 */
export function instanceOfListWalletSessionsOut(value: object): value is ListWalletSessionsOut {
    if (!('sessions' in value) || value['sessions'] === undefined) return false;
    return true;
}

export function ListWalletSessionsOutFromJSON(json: any): ListWalletSessionsOut {
    return ListWalletSessionsOutFromJSONTyped(json, false);
}

export function ListWalletSessionsOutFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListWalletSessionsOut {
    if (json == null) {
        return json;
    }
    return {
        
        'sessions': ((json['sessions'] as Array<any>).map(WalletSessionFromJSON)),
    };
}

export function ListWalletSessionsOutToJSON(json: any): ListWalletSessionsOut {
    return ListWalletSessionsOutToJSONTyped(json, false);
}

export function ListWalletSessionsOutToJSONTyped(value?: ListWalletSessionsOut | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'sessions': ((value['sessions'] as Array<any>).map(WalletSessionToJSON)),
    };
}

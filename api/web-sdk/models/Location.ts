...
/**
 * Where an object was left for another user to find.
 * 
 * @export
 * @interface Location
 */
export interface Location {
    ...
    longitude: number;
    /**
     * The same place as a short string, which is what the `geo_hash` filter
     * searches by. The longer it is, the smaller the area it covers.
     * 
     */
    geoHash: string;
}

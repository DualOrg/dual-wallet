...
/**
 * Who is signing in, and how. Send an email address or a phone number, plus
 * either a password or a one-time code.
 * 
 * @export
 * @interface LoginIn
 */
export interface LoginIn {
    /**
     * The organization the account belongs to. Leave it out for an account that
     * is not tied to one — the same address can exist in both places.
     * 
     */
    ...
    email?: string;
    /**
     * The phone number on the account, written internationally, for example
     * `+12125551234`.
     * 
     */
    phoneNumber?: string;
    /**
     * Their password. Send this or `otp`, not both.
     */
    password?: string;
    /**
     * The code sent by `POST /auth/otp`. Send this or `password`, not both.
     * Signing in this way also confirms the address it was sent to.
     * 
     */
    otp?: string;
}

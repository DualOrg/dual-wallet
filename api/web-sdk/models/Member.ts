...
/**
 * One person's place in an organization: the email they were invited at, the
 * role they hold, and whether they have accepted.
 * 
 * @export
 * @interface Member
 */
export interface Member {
    /**
     * Identifier of this membership record, not the member's wallet.
     */
    id: string;
    /**
     * Their wallet, once they have accepted. Absent while an invitation is still
     * outstanding.
     * 
     */
    walletId?: string;
     ...
     * | `declined` | Turned the invitation down |
     * 
     */
    inviteStatus: MemberInviteStatusEnum;
    /**
     * The role they hold. Change it with `PATCH`.
     */
    roleName: string;
    /**

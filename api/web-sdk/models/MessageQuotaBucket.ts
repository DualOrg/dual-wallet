 ...
 * @export
 * @interface MessageQuotaBucket
 */
export interface MessageQuotaBucket {
    /**
     * Messages accepted inside the current window.
     */
    used: number;
    /**
     * Messages this bucket allows per window.
     */
    limit: number;
    /**
     * Messages still allowed. Never negative.
     */
    remaining: number;
}

/**
 * Check if a given object implements the MessageQuotaBucket interface.
 */
export function instanceOfMessageQuotaBucket(value: object): value is MessageQuotaBucket {
...
export function MessageQuotaBucketFromJSON(json: any): MessageQuotaBucket {
    return MessageQuotaBucketFromJSONTyped(json, false);
}

export function MessageQuotaBucketFromJSONTyped(json: any, ignoreDiscriminator: boolean): MessageQuotaBucket {
    if (json == null) {
        return json;
    }
    return {
...
export function MessageQuotaBucketToJSON(json: any): MessageQuotaBucket {
    return MessageQuotaBucketToJSONTyped(json, false);
}

export function MessageQuotaBucketToJSONTyped(value?: MessageQuotaBucket | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }

...
/**
 * Where a message is in its delivery life cycle.
 * 
 * | Value | Meaning |
 * | --- | --- |
 ...
 * | `uncertain` | The provider call timed out or was interrupted. It may or may not have been sent, and it is not retried automatically, because a duplicate email is worse than a missing one |

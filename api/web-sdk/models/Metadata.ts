...
/**
 * What people see: the name, description and picture shown wherever an object or
 * a template appears.
 * 
 * @export
 * @interface Metadata
...
export interface Metadata {
    ...
    description?: string;
    /**
     * Your own grouping label, shown alongside the name.
     */
    category?: string;
    /**
     * 
    ...
    image?: Asset;
    /**
     * Which one of a numbered run this is.
     */
    edition?: number;
}

...
export interface Mint {
    /**
     * The template to make them from.
     * 
     */
    templateId: string;
    /**
     * How many to create, at least one. They come back in the result's `ids`.
     * 
     */
    num: number;
    /**
     * Who receives the new objects: an Ethereum address or the email address of
     * an existing wallet in the same organization. Leave it out to keep them
     * yourself.
     * 
     */
    to?: string;
    /**
     * Starting details for the new objects, overriding what the template says.
     * 
     */
    data?: MintData;
}

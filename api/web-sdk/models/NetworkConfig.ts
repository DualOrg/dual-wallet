...
/**
 * Chain endpoints and contract addresses for this deployment. Read them at
 * runtime rather than hard-coding them.
 * 
 * @export
...
export interface NetworkConfig {
    ...
    /**
     * The DAO contract address on the network, when one is deployed.
     */
    dao?: string;
    /**
...
export function NetworkConfigFromJSONTyped(json: any, ignoreDiscriminator: boolean): NetworkConfig {
    ...
    return {
        ...
        'dao': json['dao'] == null ? undefined : json['dao'],

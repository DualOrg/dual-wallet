...
/**
 * What one action costs right now. Every amount appears twice: in whole DUAL,
 * and in wei.
 * 
 * @export
...
export interface NetworkFees {
    /**
     * The DUAL price these figures were worked out at.
     */
    tokenPrice: string;
    /**
    ...
    baseFeeWei: string;
    /**
     * The part that follows what it currently costs the network to settle work,
     * in DUAL.
     * 
     */
    dynamicFee: string;
    /**
     * The same part, in wei.
     */
    dynamicFeeWei: string;
    /**
     * What one action costs altogether, in DUAL.
     */
    totalFee: string;
    /**
     * What one action costs altogether, in wei.
     */
    totalFeeWei: string;
}

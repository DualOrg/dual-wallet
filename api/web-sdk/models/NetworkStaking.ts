...
export interface NetworkStaking {
    ...
    rewardRate?: string;
    /**
     * Address of the fee dispatcher that sends fees to the contract.
     */
    feeDispatcher?: string;
    /**
     * Unix time of the last reward update.
     */
    ...
    /**
     * DUAL parked but not yet notified into the active stream (wei).
     * 
     */

...
/**
 * Current DUAL market, supply, volume, and historical-extreme metrics.
 * @export
 * @interface NetworkTokenMarketData
 */
export interface NetworkTokenMarketData {
    /**
     * Current DUAL price keyed by lowercase currency code.
     */
    currentPrice?: { [key: string]: number; };
    /**
     * Total value locked in the network, when reported by the market-data source.
     */
    totalValueLocked?: any | null;
    /**
     * Market capitalization divided by total value locked.
     */
    ...
    /**
     * Return-on-investment data supplied by the market-data source.
     */
    roi?: any | null;
    /**
    ...
    /**
     * DUAL's rank among tracked tokens by market capitalization.
     */
    ...
    /**
     * When the market-data source last updated these values.
     */
    lastUpdated?: Date;
}

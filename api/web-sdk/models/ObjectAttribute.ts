...
/**
 * One named detail attached to an object after it was created — a tier, a
 * stamp, a verification result. Set and removed by actions, never edited
 * directly.
 * 
 * @export
...
export interface ObjectAttribute {
    /**
     * Identifier of this attribute record.
     */
    id: string;
    /**
    ...
    key: string;
    /**
     * What the attribute says right now. Any JSON value: text, a number, a
     * list, an object.
     * 
     */
    value: any | null;
    /**
     * Your own grouping label, for filtering related attributes together.
     */
    category?: string;
    /**
     * How to interpret the value, when it is more than plain text.
     */
    contentType?: AttributeContentType;
    /**
     * Whether anyone can see this attribute in the object's public view and in
     * how it is drawn. Private by default.
     * 
     */
    _public: boolean;
    /**
     * A fingerprint of this attribute, used when proving it was not altered.
     */
    valueHash: string;
    /**
     * Action that most recently set this attribute value.
     */
    actionId: string;
    /**
     * The point in the object's life at which this value was set.
     */
    objectNonce: number;
    /**
     * When this attribute was first added to the object.
     */
    whenCreated: Date;
    /**
     * When this attribute value last changed.
     */
    whenModified: Date;
}

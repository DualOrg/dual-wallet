 ...
 * not contain face source, internal renderer configuration, or template content.
 * It may contain the selected face view's explicitly public configuration.
 * 
 * @export
...
export interface ObjectDisplay {
    ...
    mediaType: string;
    /**
     * Relative API path or HTTPS URL for the resolved representation. For a

...
/**
 * The company or team that owns and pays for everything: objects, templates,
 * faces, files, webhooks and keys.
 * 
 * @export
...
export interface Organization {
    ...
    id: string;
    /**
     * A domain name of the organization's own, when it uses one for its public
     * pages.
     * 
     */
    fqdn?: string;
    /**
     * The wallet that owns the organization.
     */
    ownerId?: string;
    /**
    ...
    image?: Asset;
    /**
     * Everyone in the organization and the role each holds. Invite tokens are
     * never included.
     * 
     */
    members?: Array<Member>;
    /**
     * The roles this organization has defined.
     */
    roles?: Array<Role>;
    /**

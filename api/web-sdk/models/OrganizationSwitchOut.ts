...
/**
 * The new session, and the organization it belongs to.
 * @export
 * @interface OrganizationSwitchOut
 */
export interface OrganizationSwitchOut {
    /**
     * Use this from now on. Everything it is sent with happens inside the
     * organization it names. The refresh token you already hold keeps
     * working.
     * 
     */
    accessToken: string;

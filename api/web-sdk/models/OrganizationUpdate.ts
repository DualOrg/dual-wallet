...
/**
 * The parts of an organization to change. Send only what you want changed.
 * 
 * @export
...
export interface OrganizationUpdate {
    ...
    name?: string;
    /**
     * A note about what the organization does.
     */
    description?: string;
    /**
     * The organization's logo. Upload it with `POST /assets` first.
     */
    image?: Asset;
}

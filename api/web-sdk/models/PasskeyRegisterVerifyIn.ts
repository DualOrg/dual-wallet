...
/**
 * JSON produced by calling `toJSON()` on the credential returned from
 * `navigator.credentials.create()`. Add the required organization identifier
 * and any optional wallet metadata before submitting it.
 * 
 * @export
...
export interface PasskeyRegisterVerifyIn {
    ...
    /**
     * Organization the new wallet will belong to. This field is required.
     */

...
/**
 * Relying-party account descriptor shown by the authenticator during registration.
 * @export
...
export interface PasskeyUser {
    ...
    id: string;
    /**
     * Relying-party identifier used as the account name in passkey UI.
     */
    name: string;
    /**
     * Human-readable relying-party name shown in browser or operating-system passkey UI.
     */
    displayName: string;
}

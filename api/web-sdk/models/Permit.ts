...
/**
 * Let another account run one action on your object, once, without handing it
 * over.
 * 
 * They present the secret behind `commitment` when they act. Useful for a
 * delegated redemption at a door, or a transfer another account completes.
 * 
 * @export
 * @interface Permit
 */
export interface Permit {
    ...
    id: string;
    /**
     * Which action they are being allowed to run, for example `transfer`.
     * 
     */
    scope: string;
    /**
     * A fingerprint of the secret you will give them. They present the secret
     * itself; only its fingerprint is stored here.
     * 
     */
    commitment: string;
    /**
     * The object's action number the permission is tied to.
     * 
     */
    nonce?: number;
    /**
     * Restrict the permission to one address. Leave it out to let anybody holding
     * the secret use it.
     * 
     */
    recipient?: string;
    /**
     * When the permission stops working.
     * 
     */
    deadline?: Date;
}

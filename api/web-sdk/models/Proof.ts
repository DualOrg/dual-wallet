...
/**
 * Cryptographic proof that the batch or checkpoint transition is valid.
 * @export
 * @interface Proof
 */
export interface Proof {
    /**
     * Proof system used, for example a zk-SNARK implementation.
     */
    type: string;
    /**
     * Encoded proof bytes.
    ...
    value: string;
    /**
     * Encoded public inputs checked with the proof.
     */
    publicValues: string;
    /**
     * Encoded verification key needed to check the proof.
     */
    vkey: string;
    /**
     * Diagnostic message supplied by the prover, when present.
     */
    message?: string;
}

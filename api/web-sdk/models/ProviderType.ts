 ...
 * | Value | What it means |
 * | --- | --- |
 * | `gcs` | Ordinary storage. The file can be private, and download links last fifteen minutes |
 * | `ipfs` | Published to the InterPlanetary File System. Always public, with a permanent address anyone can use |
 * 
 * Chosen once, when the file is uploaded, and fixed from then on.
 * 
 * @export
 */

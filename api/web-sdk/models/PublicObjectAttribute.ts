...
/**
 * One detail attached to an object that has been marked public.
 * 
 * @export
...
export interface PublicObjectAttribute {
    /**
     * The attribute's name, lower-cased.
     */
    key: string;
    /**
     * What the attribute says right now.
     */
    value: any | null;
    /**
     * The grouping label the issuer gave it.
     */
    category?: string;
    /**

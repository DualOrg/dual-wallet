...
/**
 * An object as anyone can see it: the details its template publishes, plus who
 * holds it and the fingerprints that let its history be checked.
 * 
 * @export
...
export interface PublicSmartObject {
    ...
    system?: object;
    /**
     * Only the fields the template lists as public. Everything else is left
     * out.
     * 
     */
    custom?: object;
    /**
     * A fingerprint of the object's own data.
     */
    customHash?: string;
    /**
    ...
    metadata: Metadata;
    /**
     * Ethereum address that currently owns the object.
     */
    owner: string;
    /**
     * Template that defines this object's starting data and available actions.
     */
    templateId: string;
    /**
     * Current geographic location, when the object has been placed somewhere.
     */
    location?: Location;
    /**
     * Number of state changes recorded for this object.
     */
    nonce: number;
    /**
     * Version of the object's record format.
     */
    version: number;
    /**
     * Fingerprint of the object's current owner and state.
     */
    stateHash: string;
    /**
     * Fingerprint of the object's metadata, assets, location, and custom data.
     */
    contentHash: string;
    /**
     * Current fingerprint of the object's complete change history.
     */
    integrityHash: string;
    /**
     * History fingerprint immediately before the latest change.
     */

...
/**
 * An object described the way wallets and marketplaces expect a collectible to
 * be described.
 * 
 * @export
...
export interface PublicSmartObjectMetadata {
    ...
    image: string;
    /**
     * Its traits, as name and value pairs — the rows a marketplace lists under
     * the picture.
     * 
     */
    attributes: Array<PublicSmartObjectMetadataAttributesInner>;
    /**
     * A link to the object's own page.
     */
    externalUrl: string;
}

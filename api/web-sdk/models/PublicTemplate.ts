...
/**
 * A template as anyone can see it: what it is called, what can be done with
 * objects made from it, and only the details the organization chose to show.
 * 
 * @export
...
export interface PublicTemplate {
    ...
    id: string;
    /**
     * Public name of this kind of object.
     */
    name: string;
    /**
     * Starting metadata and public custom data for objects made from this template.
     */
    object: PublicTemplateObject;
    /**
     * Supply limit and creation window, when the template restricts creation.
     */
    factory?: Factory;
    /**
     * Actions supported by objects made from this template.
     */
    actions: Array<TemplateAction>;
    /**
     * Face selected to present objects made from this template.
     */
    faceId?: string;
    /**

...
/**
 * Use an object up — scan a ticket at the door, claim a voucher.
 * 
 * Depending on how its template is set up, redeeming may destroy the object,
 * or destroy it and give something else back in its place.
 * 
 * @export
 * @interface Redeem
 */
export interface Redeem {
    /**
     * The object being redeemed.
     * 
     */
    id: string;
    /**
     * The template of what to give back, where the template offers a choice.
     * 
     */
    templateId?: string;
}

...
/**
 * Hand the decision to a service of your own.
 * 
 * The template names an address; we call it with the object and your data, and
 * apply whatever changes it asks for. Use it for rules that live in your own
 * system — stock levels, eligibility, an external booking.
 * 
 * @export
 * @interface Remote
 */
export interface Remote {
    ...
    id: string;
    /**
     * Anything you want passed on to your service.
     * 
     */
    data?: { [key: string]: any; };
}

...
/**
 * Account contact and scope to which a one-time sign-in code should be sent.
 * @export
...
export interface RequestOTPCodeIn {
    ...
    email?: string;
    /**
     * Where to send the code, written internationally.
     */
    phoneNumber?: string;
    /**
     * The organization the account belongs to. Leave it out for an account

...
/**
 * A new role to define.
 * @export
 * @interface RoleCreate
 */
export interface RoleCreate {
    /**
     * What to call the role. Unique within the organization, ignoring
     * case, and fixed once created.
     * 
     */
    name: string;
    /**
     * A note about what this role is for.
     */
    description?: string;
    /**
     * What the role allows. Never more than the person creating it holds
     * themselves.
     * 
     */

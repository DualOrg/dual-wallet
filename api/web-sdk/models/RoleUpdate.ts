...
/**
 * The parts of a role to change. A role's name is fixed once it is
 * created.
 * 
 * @export
...
export interface RoleUpdate {
    ...
    description?: string;
    /**
     * The complete list of what the role allows. Include everything it
     * should keep — anything left out is taken away.
     * 
     */

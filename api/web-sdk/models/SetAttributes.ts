...
/**
 * Add or change named details on an object — a stamp, an upgrade, a
 * verification result.
 * 
 * Each one can be public or private, and every change is recorded in the
 * object's history like any other action.
 * 
 * @export
...
export interface SetAttributes {
    ...
    /**
     * The details to set, up to 100 at a time. One that already exists is
     * replaced.
     * 
     */

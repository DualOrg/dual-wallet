...
/**
 * One thing made from a template — a ticket, a card, a warranty. It has an owner
 * and a history that can be proved.
 * 
 * @export
...
export interface SmartObject {
    ...
    id: string;
    /**
     * The organization that issued this object.
     */
    orgId: string;
    /**
     * Where the object stands on chain, once it has been mirrored there.
     */
    chain?: Chain;
    /**
    ...
    system?: object;
    /**
     * Your own data on this object as it stands now — seat, tier, expiry,
     * whatever the template defined. Changed by running an `update` action.
     * 
     */
    custom?: object;
    /**
     * A fingerprint of `custom`, used when proving history.
     */
    customHash?: string;
    /**
    ...
    metadata: Metadata;
    /**
     * Files attached to this object.
     */
    assets?: Array<Asset>;
    /**
     * The address holding this object right now. Empty while the object is
     * dropped and waiting to be picked up.
     * 
     */
    owner: string;
    /**
     * The template this object was made from.
     */
    templateId: string;
    /**
     * Where the object was dropped, if it is waiting to be picked up.
     */
    location?: Location;
    /**
     * How many times this object has changed. Every action raises it by one,
     * which is what makes a signed action impossible to replay.
     * 
     */
    nonce: number;
    /**
     * Which version of the object format this record uses.
     */
    version: number;
    /**
     * A fingerprint of who owns the object and where it sits.
     */
    stateHash: string;
    /**
     * A fingerprint of everything the object carries.
     */
    contentHash: string;
    /**
     * A fingerprint that chains this object's whole history together. This is
     * what a proof checks.
     * 
     */
    integrityHash: string;
    /**
     * The same fingerprint as it stood before the last change.
     */

...
/**
 * What a staking event did.
 * 
 * | Value | Meaning |
 * | --- | --- |
 * | `stake` | Tokens were staked |
 * | `unstake` | Tokens were withdrawn |
 * | `reward` | Rewards were distributed to stakers |
 * | `fee_dispatch` | Network fees were sent into the staking contract |
 * | `other` | An event that maps to none of the above |
 * 
 * @export
 */

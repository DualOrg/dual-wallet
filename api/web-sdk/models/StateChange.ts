...
/**
 * One thing that happened to an object: what was done, who did it, what the
 * object looked like before and after, and which batch made it permanent.
 * 
 * @export
...
export interface StateChange {
    ...
    id: string;
    /**
     * Wallet that submitted the action responsible for this change.
     */
    walletId?: string;
    /**
    ...
    objectId: string;
    /**
     * Action-log entry that caused this change.
     */
    actionId: string;
    /**
     * What was done, for example `mint`, `transfer` or `redeem`.
     */
    actionName: string;
    /**
     * 
    ...
    /**
     * Exactly what the action changed, for actions that set or remove
     * attributes. Left out for other kinds of change.
     * 
     */
    change?: object;
    /**
     * The object's fingerprint before this change.
     */
    prevStateHash: string;
    /**
     * The object's fingerprint after it.
     */
    nextStateHash: string;
    /**
     * The history fingerprint before this change.
     */
    prevIntegrityHash: string;
    /**
     * The history fingerprint after it.
     */
    nextIntegrityHash: string;
    /**
     * How many times the object had changed before this one.
     */
    prevNonce: number;
    /**
     * How many times it had changed after.
     */
    nextNonce: number;
    /**
     * A fingerprint of everything the object carried before.
     */
    prevContentHash: string;
    /**
     * A fingerprint of everything it carried after.
     */
    nextContentHash: string;
    /**
     * Who held the object before.
     */
    prevOwner: string;
    /**
     * Who holds it now.
    ...
    currentOwner: string;
    /**
     * The proof that this change is included in its batch. Use it to verify the
     * change against what was written on chain.
     * 
     */
    merkleProof: Array<string>;
    /**
     * The batch that made this change permanent. Look it up with
     * `GET /batches/{batchId}`.
     * 
     */
    batchId: string;
    /**
     * The transaction that mirrored this change on chain, where one exists.
     */
    l1TxHash?: string;
    /**
     * When it happened.

...
/**
 * A set of figures. `total` always comes back; `breakdown` and `series` only
 * when you ask for them with `include`, since each one is extra work.
 * 
 * @export
 * @interface StatsOut
 */
export interface StatsOut {
    /**
     * The headline number for the window you asked for.
     */
    total: number;
    /**
     * 
    ...
    interval?: Interval;
    /**
     * The same total, split by whatever you grouped on. Comes back with
     * `include=breakdown`.
     * 
     */
    breakdown?: Array<StatsBucket>;
    /**
     * The figures over time, one point per period. Comes back with
     * `include=series`.
     * 
     */

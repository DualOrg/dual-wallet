...
export interface StatsPoint {
    /**
     * The start of the period. It runs up to, but not including, the start of
     * the next one.
     * 
     */
    when: Date;
    /**
     * Which slice this point belongs to, when you asked for a series split by
     * something. Absent when the series covers everything at once — so its
     * presence tells you which kind of series you are looking at.
     * 
     */
    key?: string;
    /**
     * How many there are in this period.
     */
    count: number;
}

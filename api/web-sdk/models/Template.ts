...
/**
 * The blueprint for one kind of object: what it carries, how it looks, what can
 * be done with it and how many may exist.
 * 
 * @export
 * @interface Template
 */
export interface Template {
    ...
    id: string;
    /**
     * The address of whoever created the template.
     */
    owner?: string;
    /**
     * What this kind of object is called. Unique within your organization.
     * 
     */
    name: string;
    /**
     * The domain name this template is published under, for organizations that
    ...
    /**
     * How many objects may exist and when they may be created.
     * 
     */
    factory?: Factory;
    /**
    ...
    /**
     * What can be done with objects made from this template, and by whom.
     */
    actions: Array<TemplateAction>;
    /**
     * The face objects made from this template wear.
     */
    faceId?: string;
    /**

...
import type { ActionNotifications } from './ActionNotifications';
import {
    ActionNotificationsFromJSON,
    ActionNotificationsFromJSONTyped,
    ActionNotificationsToJSON,
    ActionNotificationsToJSONTyped,
} from './ActionNotifications';

/**
 * Something that can be done with an object, and who may do it.
 * 
 * @export
...
export interface TemplateAction {
     ...
     * | Action | What happens |
     * | --- | --- |
     * | `mint` | A new object is created |
     * | `transfer` | It changes hands |
     * | `burn` | It is destroyed |
     * | `update` | Its own data changes |
     * | `redeem` | It is used up, and may produce something in return |
     * | `drop` | It is left at a place for someone to find |
     * | `pickup` | A user picks up a dropped object |
     * | `connect` | It is attached to another object |
     * | `set_attributes`, `delete_attributes` | Named attributes are added or removed |
     * | `bridgeNFT` | It is mirrored on chain as a collectible |
     * | `remote` | Your own service decides what happens |
     * 
     */
    name: TemplateActionNameEnum;
    /**
     * Your own name for this action, shown in place of the standard one — for
     * example `check-in` instead of `redeem`.
     * 
     */
    alias?: string;
    /**
    ...
    /**
     * External checks that must approve the action before it can run.
     */
    validators?: Array<Validators>;
    /**
     * Settings for this action, such as what a `redeem` gives back in return.
     * 
     */
    config?: object;
    /**
     * For a `remote` action, the address of your own service, which decides what
     * happens when the action runs.
     * 
     */
    url?: string;
}
...
export function TemplateActionFromJSONTyped(json: any, ignoreDiscriminator: boolean): TemplateAction {
    ...
    return {
        ...
        'notifications': json['notifications'] == null ? undefined : ActionNotificationsFromJSON(json['notifications']),
...
export function TemplateActionToJSONTyped(value?: TemplateAction | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'notifications': ActionNotificationsToJSON(value['notifications']),

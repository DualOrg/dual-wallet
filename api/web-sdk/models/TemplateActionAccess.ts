...
/**
 * Who is allowed to run this action.
 * @export
...
export interface TemplateActionAccess {
     ...
     * | `whitelist` | Only listed addresses |
     * | `token` | Only holders of the tokens named below |
     * 
     */
    type: TemplateActionAccessTypeEnum;
    /**
     * Which tokens the caller must hold, and how many, when access is `token`.
     * 
     */

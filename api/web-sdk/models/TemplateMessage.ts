...
/**
 * A message template owned by your organization. One template exists per
 * combination of action type, language and channel.
 * 
 * @export
...
export interface TemplateMessage {
    ...
    /**
     * Subject line, unrendered. May contain `{{.variable}}` placeholders.
     */
    title?: string;
    /**
    ...
    project?: string;
    /**
     * Message body before template values are substituted.
     */
    content: string;
    /**
     * 
    ...
    /**
     * Default values for placeholders used by this template. Send-time values
     * override these defaults.
     * 
     */
    values?: { [key: string]: string; };
    /**
     * When this template was last changed.
     */
    whenModified: Date;
    /**

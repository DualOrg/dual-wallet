...
/**
 * The fields of a template to change. Every field is optional; only what you
 * send is changed.
 * 
 * @export
...
export interface TemplateMessageUpdate {
    ...
    /**
     * Replacement subject line. Parsed before it is stored.
     */
    title?: string;
    /**
    ...
    project?: string;
    /**
     * Replacement body. Parsed before it is stored.
     */
    content?: string;
    /**
     * 
    ...
    /**
     * Replacement defaults for this template's variables.
     */

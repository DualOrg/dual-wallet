...
/**
 * What an object carries: the part people see, and your own data.
 * 
 * @export
...
export interface TemplateObject {
    ...
    system?: object;
    /**
     * Your own data — seat numbers, tiers, expiry dates, anything you need. Each
     * object starts with these values and can change them later.
     * 
     * Only the fields you name in the template's `public_access` are visible to
    ...
    metadata: Metadata;
    /**
     * Files attached to every object created from this template.
     */
    assets?: Array<Asset>;
}

...
/**
 * Changes to what objects made from a template carry.
 * 
 * @export
...
export interface TemplateObjectUpdate {
    /**
     * Replacement starting values for template-specific object data.
     */
    custom?: object;
    /**
     * Replacement name, description, category, and image defaults.
     */
    metadata?: Metadata;
    /**
     * Replacement list of files attached to newly created objects.
     */
    assets?: Array<Asset>;
}

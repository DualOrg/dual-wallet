...
/**
 * The parts of a template to change. Send only what you want changed.
 * 
 * @export
...
export interface TemplateUpdate {
    /**
     * Changes to the starting data carried by newly created objects.
     */
    object?: TemplateObjectUpdate;
    /**
     * Changes to supply limits and the object-creation window.
     */
    factory?: FactoryUpdate;
    /**
     * Replacement list of actions supported by the template.
     */
    actions?: Array<TemplateAction>;
    /**
     * Replacement rules for fields visible to anonymous callers.
     */
    publicAccess?: PublicAccess;
    /**
     * Face to use when presenting objects made from this template.
     */
    faceId?: string;
    /**
     * Updated automatically to the time of this template change.
     */
    whenModified?: Date;
}

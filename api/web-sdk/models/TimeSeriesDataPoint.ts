...
/**
 * One period of a series: when it starts, and the figures for it.
 * 
 * @export
...
export interface TimeSeriesDataPoint {
    /**
     * Identifier of the stored record represented by this point, when one exists.
     */
    id?: string;
    /**
     * Which slice this point belongs to, when the series is split.
     */
    key?: string;
    /**
    ...
    when?: Date;
    /**
     * How many there were in this period.
     */
    count?: number;
    /**
     * How much they came to, in wei, where the series measures amounts.
     */
    amount?: string;
}

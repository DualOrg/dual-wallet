...
/**
 * Change the details an object carries.
 * 
 * @export
 * @interface Update
 */
export interface Update {
    ...
    id: string;
    /**
     * The fields to change and their new values. Anything you leave out stays as
     * it is.
     * 
     */
    data?: { [key: string]: any; };
    /**
     * The secret behind a permit, when you are acting under another account's
     * authority.
     * 
     */
    secret?: string;

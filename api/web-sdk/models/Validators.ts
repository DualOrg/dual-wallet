...
/**
 * An extra check your own service makes before an action is allowed.
 * 
 * @export
...
export interface Validators {
    /**
     * How the check is made. `http` calls the address below.
     */
    type: ValidatorsTypeEnum;
    /**
     * Where to ask. Answer positively to let the action through.
     * 
     */
    url?: string;
}

...
/**
 * An email address being confirmed, and the code that confirms it.
 * @export
 * @interface VerifyIn
 */
export interface VerifyIn {
    ...
    email?: string;
    /**
     * The phone number the code was sent to, written internationally.
     * 
     */
    phoneNumber?: string;
    /**
     * The organization the account belongs to. Leave it out for an account
     * that is not tied to one — the same address can exist in both places,
     * and this is how we know which of them is being confirmed.
     * 
     */

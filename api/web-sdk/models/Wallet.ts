...
/**
 * A user's identity on the Dual network: their address, how they sign in, and
 * what they are called. Passwords and keys are never included.
 * 
 * @export
 * @interface Wallet
 */
export interface Wallet {
    ...
    email?: string;
    /**
     * Their phone number, if they gave one.
     */
    phoneNumber?: string;
    /**
     * 
    ...
    language: Language;
    /**
     * The domain the account belongs to — an organization's own, or the open
     * network.
     * 
     */
    fqdn: string;
    ...
    disabled: boolean;
    /**
     * Their address on the network, and the details of the smart account behind
     * it. This is what owns objects and signs actions.
     * 
     */
    account: Account;
    /**
     * The passkey tied to this account, if they signed up with one.
     * 
     */
    passkey?: PasskeyCredential;
    /**
     * Keys this account has authorised to act on its behalf for a limited time.
     * 
     */
    sessions?: Array<Session>;
    /**
     * Whether they are still working through first-time setup.
     */
    onboarding?: boolean;
    /**

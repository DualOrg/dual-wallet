...
export interface WalletCreate {
    /**
     * Organization this member account belongs to. Required by `POST /wallets`.
     * Do not send it to `POST /organizations/wallets`, where it is ignored.
     * 
     */
    ...
    nickname?: string;
    /**
     * Their email address. Required, and it has to be free in the account's
     * organization or network scope.
     * 
     */
    email?: string;
    /**
     * Their phone number, written internationally, for example `+12125551234`.
     * 
     */
    phoneNumber?: string;
    /**
    ...
    language?: Language;
    /**
     * A profile picture. Upload it with `POST /assets` first.
     */
    avatar?: Asset;
    /**

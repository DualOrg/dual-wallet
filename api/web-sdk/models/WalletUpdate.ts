...
/**
 * The details of an account to change. Send only what you want changed.
 * 
 * @export
...
export interface WalletUpdate {
    ...
    avatar?: Asset;
    /**
     * Whether the user is still working through first-time setup. The value is persisted and returned on wallet reads.
     */
    onboarding?: boolean;
}

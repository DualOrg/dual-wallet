...
/**
 * Logical webhook delivery usage for the caller's active organization.
 * @export
 * @interface WebhookQuota
 */
export interface WebhookQuota {
    /**
     * Logical webhook deliveries created inside the rolling window. Retries and manual redeliveries do not add usage.
     */
    used: number;
    /**
     * Included logical webhook deliveries per rolling window.
     */
    limit: number;
    /**
     * Included deliveries remaining in the rolling window. Never negative; usage can exceed the allowance.
     */
    remaining: number;
    /**
     * Length of the rolling usage window in seconds.
     */
...
export function WebhookQuotaFromJSONTyped(json: any, ignoreDiscriminator: boolean): WebhookQuota {
    if (json == null) {
        return json;
    }
    return {
...
export function WebhookQuotaToJSONTyped(value?: WebhookQuota | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }

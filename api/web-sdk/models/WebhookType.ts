...
/**
 * The category of action event in a delivery record and delivered payload.
 * Subscription matching is configured separately through template-scoped
 * webhook rules.
 * 
 * | Value | Event category |
 * | --- | --- |
 * | `address_activity` | Actions sent by particular wallet addresses |
 * | `template_activity` | Actions affecting objects of particular templates |
 * | `action_activity` | Particular action names, wherever they occur |
 * 
 * @export
 */
